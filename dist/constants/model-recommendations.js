...
exports.MODEL_RECOMMENDATIONS = [
    ...
    },
    {
        id: 'llama-3.3-70b',
        name: 'Llama 3.3 70B',
        description: 'Balanced high-intelligence model with strong general performance and function calling support',
    ...
    },
    {
        ...
        name: 'Dolphin 72B',
        description: 'Uncensored 72B model, excellent for creative writing and storytelling with minimal refusals',
        useCase: [
            'creative writing',
            'storytelling',
            'uncensored content',
    ...
    // Image Generation Models
    {
        id: 'venice-sd35',
        name: 'Venice SD35',
        description: "Venice's custom Stable Diffusion 3.5 model with improved aesthetics, lighting, and realistic anatomy rendering",
    ...
    },
    {
        ...
        description: 'Latest Stable Diffusion 3.5 Large model from Stability AI with enhanced quality and coherence',
        useCase: ['general purpose', 'high quality', 'photorealistic', 'artistic'],
        pros: [
            'Latest SD version',
            'High quality output',
    ...
    },
    {
        id: 'flux-dev',
        name: 'FLUX Standard',
        description: 'State-of-the-art FLUX.1-dev model with exceptional prompt adherence and image quality',
    ...
    },
    {
        id: 'pony-realism',
        name: 'Pony Realism',
        description: 'Specialized model for highly detailed realistic images of people, landscapes, and still-life (most uncensored)',
        useCase: [
            'realistic people',
            'landscapes',
            'still-life',
    ...
    },
    {
        id: 'lustify-sdxl',
        name: 'Lustify SDXL',
        description: 'NSFW-focused SDXL checkpoint for adult content generation with enhanced anatomy and detail',
