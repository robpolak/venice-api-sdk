...
class ApiRequest {
    ...
    mergeConfig(config) {
        var _a;
        const commonParams = ((_a = this.options.request) === null || _a === void 0 ? void 0 : _a.axiosParams) || {};
        return Object.assign(Object.assign({}, config), { params: Object.assign(Object.assign({}, commonParams), (config && config.params)) });
    }
    /**
