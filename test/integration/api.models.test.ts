        ...
        messages: [
          {
            ...
            content:
              'You are a helpful assistant. You give one word answers, no more than just one word.  If I ask for the capital of a city you give just one lowercase word response.  ',
          },
